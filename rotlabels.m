...
% ROTLABELS Rotate x-, y-, and z-labels to be parallel with the axes.
%
% ROTLABELS rotates the x-, y-, and z-labels of the current 3-D plot
...
% proportions (as opposed to onscreen proportions).
%
% [RX,RY,RZ] = ROTLABELS(...) will compute the rotation angles but
...
[junk,ix]=min((lp(1,2)-axl(2,[1 1 2 2])).^2+(lp(1,3)-axl(3,[1 2 1 2])).^2);
[junk,iy]=min((lp(2,1)-axl(1,[1 1 2 2])).^2+(lp(2,3)-axl(3,[1 2 1 2])).^2);
[junk,iz]=min((lp(3,1)-axl(1,[1 1 2 2])).^2+(lp(3,2)-axl(2,[1 2 1 2])).^2);
ix1 = [1 2; 5 6; 3 4; 7 8];
iy1 = [1 3; 5 7; 2 4; 6 8];
iz1 = [1 5; 3 7; 2 6; 4 8];
...
if (r(1)>90), r(1)=r(1)-180; elseif (r(1)<=-90), r(1)=r(1)+180;
end;
if (r(2)>90), r(2)=r(2)-180; elseif (r(2)<=-90), r(2)=r(2)+180;
end;
if (r(3)<0), r(3)=r(3)+180; end;
