...
if horizontalFlag
    ...
    hReg2(end+1) = rectangle('Position',[boxEdge(1),y-barWidth/2,IQR,barWidth],'linewidth',linewidth,'EdgeColor','none','FaceColor',[.8 .8 .8]);
...
%     end
    ...
    hReg(end+1) = plot([wisEdge(1) boxEdge(1)],[y y],'-','linewidth',linewidth*2,'color',wisColor);
    hReg(end+1) = plot([boxEdge(2) wisEdge(2)],[y y],'-','linewidth',linewidth*2,'color',wisColor);
    ...
    hReg2(end+1) = rectangle('Position',[y-barWidth/2,boxEdge(1),barWidth,IQR],'linewidth',linewidth,'EdgeColor','none','FaceColor',boxColor);
    hold on;    
...
%     end
    ...
    hReg(end+1) = plot([y y],[wisEdge(1) boxEdge(1)],'-','linewidth',linewidth*2,'color',wisColor);
    hReg(end+1) = plot([y y],[boxEdge(2) wisEdge(2)],'-','linewidth',linewidth*2,'color',wisColor);
